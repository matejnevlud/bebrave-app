export const reservation500Email = `
<!DOCTYPE html>
<html lang="cs">
<head>
  <meta charset="UTF-8" />
  ...
  <tr>
    <td align="center">
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;font-family:Arial,Helvetica,sans-serif;">
        ...
        <!-- Payment note for advance payment -->
        <tr>
          <td style="padding:0 40px 24px 40px;">
            <div style="background:#fffbe6;border:1px solid #ffe58f;border-radius:6px;padding:16px 20px;margin-bottom:16px;">
