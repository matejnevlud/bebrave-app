...
function ReservationPage() {
    ...
    useEffect(() => {
        dotyposGetCustomerCreditBalanceByEmailAndPhone(formData.email, formData.phone).then((data) => {
    ...
    const handleEmailPhoneChangeForCreditCustomer = async (newFormData: ReservationFormData) => {
        ...
        const data = await dotyposGetCustomerCreditBalanceByEmailAndPhone(email, phone);
                  ...
                  Osobní údaje
                            ...
                            {hasFreeEntry ? (
                                <div key={'green'} className="w-full flex items-center">
                                    <Alert color={'success'} title="Vstup na tuto lekci máte zdarma."/>
                                    <input type="hidden" name="paymentMethod" value="free"/>
                                </div>
                            ) : (
                                <PaymentMethodRadioGroup
                                    availableMethods={selectedClass?.classType?.allowedPaymentMethods}
