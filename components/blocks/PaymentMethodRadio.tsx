...
>(({ className, classNames, value, onChange, ...props }, ref) => {
    ...
    return (
        ...
        >
            {props.availableMethods?.includes("credit_card") && (
                <PaymentMethodItem
            ...
            {props.availableMethods?.includes("kredit") && (
                <PaymentMethodItem
                    isDisabled={props.creditBalance < props.price}
                    className="bg-content2 dark:bg-content1"
                    description={props.creditBalance === null ? "Vyplňte svůj email a telefon" : (props.creditBalance >= props.price) ? `Zůstatek (${props.creditBalance} Kč)` : `Nízký zůstatek (${props.creditBalance} Kč)`}
            ...
            {props.availableMethods?.includes("qr") && (
                <PaymentMethodItem
                    className="bg-content2 dark:bg-content1"
                    description={
                        false ? "Bankovní převod přes QR kód" : "Nedostupné"
                    }
            ...
            {props.availableMethods?.includes("osobne") && (
                <PaymentMethodItem
                    className="bg-content2 dark:bg-content1"
                    description={"Platba hotově nebo kartou na místě"}
